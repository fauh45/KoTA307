...
You can start writing assets in `kota_data_processing/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `kota_data_processing_tests` directory and you can run tests using `pytest`:

```bash
pytest kota_data_processing_tests
```
